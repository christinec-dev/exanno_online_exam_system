<?php 
    ...
    if($res_qns==true)
    {
        ...
        $subject_one=$row_qns['subject_one'];
    }
    //session check
...
<!--Exam Attempt Page Ends here-->
    <div class="main">
        <div class="content">
            ...
            <!--Prints exam questions of subject in randomized order-->
            <form method="post" action="">
                <div class="welcome">
                    ...
                    <?php 
                        ...
                        if($sn>=$subject_one)
                        {
                            $where="is_active='yes' && category='".$subject_one."' && faculty='".$faculty."' && question_id NOT IN (".$_SESSION['all_qns'].")";
                        }
                        $limit=1;
                    ...
                    <?php 
                        if(isset($_POST['submit']))
                        {
                            ...
                            $subject_taken=$subject_one;
                            $added_date=date('Y-m-d');
                            $percent = $percent_obtained;
                            //Adds student details to results table
                            $tbl_name="tbl_result";
                            $data="
