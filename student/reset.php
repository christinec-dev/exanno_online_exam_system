<!-- Reset Password Form for Students-->
<div class="main">
    <div class="login">
        <form method="post" action="">
            ...
            <p><a class="btn-reset" href="index.php?page=login">Return to Dashboard</a></p>
        </form>
            ...
            if(isset($_POST['submit']))
            {
                ...
                if($count_rows> 0)
                {
                    ...
                    if(mail($to, $subject, $message, $headers)){
                        header('location:'.SITEURL.'index.php?page=reset');
                        $_SESSION['invalid']="<div class='success'>Please check your email for your temporary password.</div>";
                    }else{
                        header('location:'.SITEURL.'index.php?page=reset');
