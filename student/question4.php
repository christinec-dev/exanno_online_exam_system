<?php 
    ...
    if($res_qns==true)
    {
        ...
        $subject_four=$row_qns['subject_four'];
    }
            ...
            <form method="post" action="">
                <div class="welcome">
                    ...
                    <?php 
                        ...
                        if($sn>=$subject_four)
                        {
                            $where="is_active='yes' && category='".$subject_four."' && faculty='".$faculty."' && question_id NOT IN (".$_SESSION['all_qns'].")";
                        }
                        $limit=1;
                        ...
                        if($res==true)
                        {
                            ...
                            {
                                header('location:'.SITEURL.'index.php?page=endSession4');
                            }
                        }
                    ?>
                    <form method="post" action="">
                    ...
                    <?php 
                        if(isset($_POST['submit']))
                        {
                            ...
                            if($res===true)
                            {
                                ...
                                header('location:'.SITEURL.'index.php?page=question4');
                            }
                            else
                            {
                                echo "Error";
