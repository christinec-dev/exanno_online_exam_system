...
ob_start(); 
    ...
    if($res_qns==true)
    {
        ...
        $subject_five=$row_qns['subject_five'];
    }
            ...
            <form method="post" action="">
                <div class="welcome">
                    ...
                    <?php 
                        ...
                        if($sn>=$subject_five)
                        {
                            $where="is_active='yes' && category='".$subject_five."' && faculty='".$faculty."' && question_id NOT IN (".$_SESSION['all_qns'].")";
                        }
                        ...
                        if($res==true)
                        {
                            ...
                            {
                                header('location:'.SITEURL.'index.php?page=endSession5');
                            }
                        }
                    ?>
                    <form method="post" action="">
                    ...
                    <?php 
                        if(isset($_POST['submit']))
                        {
                            ...
                            if($res===true)
                            {
                                ...
                                header('location:'.SITEURL.'index.php?page=question5');
                            }
                            else
                            {
                                echo "Error";
