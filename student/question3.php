<?php 
    ...
    if($res_qns==true)
    {
        ...
        $subject_three=$row_qns['subject_three'];
    }
            ...
            <form method="post" action="">
                <div class="welcome">
                    ...
                    <?php 
                        ...
                        if($sn>=$subject_three)
                        {
                            $where="is_active='yes' && category='".$subject_three."' && faculty='".$faculty."' && question_id NOT IN (".$_SESSION['all_qns'].")";
                        }
                        $limit=1;
                        ...
                        if($res==true)
                        {
                            ...
                            {
                                header('location:'.SITEURL.'index.php?page=endSession3');
                            }
                        }
                    ?>
                    <form method="post" action="">
                    ...
                    <?php 
                        if(isset($_POST['submit']))
                        {
                            ...
                            if($res===true)
                            {
                                ...
                                header('location:'.SITEURL.'index.php?page=question3');
                            }
                            else
                            {
                                echo "Error";
