    ...
    <div class="content">
        <div class="report">
            ...
            <?php 
                ...
                //Getting Values Based on added date and student id
                $tbl_name="tbl_result";
            ...
            ?>
            <!--Allows printing of results-->
            <a href="<?php echo SITEURL; ?>admin/index.php?page=dashboard">
                <button type="button" class="btn-add">BACK TO RESULTS</button>
            </a>
            <a href="">
                <button type="button" class="btn-exit" onclick="return window.print();">PRINT FEEDBACK</button>
            </a>  
        </div>
    </div>
</div>
